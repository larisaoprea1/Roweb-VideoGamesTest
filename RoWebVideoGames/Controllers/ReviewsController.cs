    ...
    public class ReviewsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Review != null ? 
                          ...
                          Problem("Entity set 'VideoGamesContext.Review'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Username,Date,Content")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Username,Date,Content")] Review review)
        {
            if (id != review.Id)
            {
                return NotFound();
